...
class RemotePointDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<RemotePoint> {
...
void TableStruct::Shutdown() {
  ...
  _RemotePoint_default_instance_.Shutdown();
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _RemotePoint_default_instance_.DefaultConstruct();
  _RemotePoint_default_instance_.get_mutable()->pointdps_ = const_cast< ::google::protobuf::PointDPS*>(
      ::google::protobuf::PointDPS::internal_default_instance());
  _RemotePoint_default_instance_.get_mutable()->pointmv_ = const_cast< ::google::protobuf::PointMV*>(
...
PointDPS::PointDPS()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_RemotePoint_2eproto::InitDefaults();
  }
  SharedCtor();
...
::google::protobuf::int32 PointDPS::value() const {
  // @@protoc_insertion_point(field_get:google.protobuf.PointDPS.value)
  return value_;
}
void PointDPS::set_value(::google::protobuf::int32 value) {
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int RemotePoint::kMsgTypeFieldNumber;
const int RemotePoint::kPointDPSFieldNumber;
const int RemotePoint::kPointMVFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
RemotePoint::RemotePoint()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:google.protobuf.RemotePoint)
}
RemotePoint::RemotePoint(const RemotePoint& from)
  : ::google::protobuf::MessageLite(),
      _internal_metadata_(NULL),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:google.protobuf.RemotePoint)
}

void RemotePoint::SharedCtor() {
...
RemotePoint::~RemotePoint() {
  // @@protoc_insertion_point(destructor:google.protobuf.RemotePoint)
  SharedDtor();
}

void RemotePoint::SharedDtor() {
...
void RemotePoint::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const RemotePoint& RemotePoint::default_instance() {
  protobuf_RemotePoint_2eproto::InitDefaults();
  return *internal_default_instance();
}

RemotePoint* RemotePoint::New(::google::protobuf::Arena* arena) const {
  RemotePoint* n = new RemotePoint;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void RemotePoint::Clear() {
// @@protoc_insertion_point(message_clear_start:google.protobuf.RemotePoint)
...
bool RemotePoint::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:google.protobuf.RemotePoint)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:google.protobuf.RemotePoint)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:google.protobuf.RemotePoint)
  return false;
#undef DO_
}

void RemotePoint::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:google.protobuf.RemotePoint)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:google.protobuf.RemotePoint)
}

size_t RemotePoint::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.RemotePoint)
  size_t total_size = 0;
...
void RemotePoint::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const RemotePoint*>(&from));
}

void RemotePoint::MergeFrom(const RemotePoint& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:google.protobuf.RemotePoint)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void RemotePoint::CopyFrom(const RemotePoint& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:google.protobuf.RemotePoint)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RemotePoint::IsInitialized() const {
  return true;
}

void RemotePoint::Swap(RemotePoint* other) {
  if (other == this) return;
  InternalSwap(other);
}
void RemotePoint::InternalSwap(RemotePoint* other) {
...
::std::string RemotePoint::GetTypeName() const {
  return "google.protobuf.RemotePoint";
}
...
// .google.protobuf.MessageType msgType = 1;
void RemotePoint::clear_msgtype() {
  msgtype_ = 0;
}
::google::protobuf::MessageType RemotePoint::msgtype() const {
...
void RemotePoint::set_msgtype(::google::protobuf::MessageType value) {
...
::google::protobuf::PointDPS* RemotePoint::release_pointdps() {
...
void RemotePoint::set_allocated_pointdps(::google::protobuf::PointDPS* pointdps) {
  delete pointdps_;
  pointdps_ = pointdps;
  if (pointdps) {
...
::google::protobuf::PointMV* RemotePoint::release_pointmv() {
...
void RemotePoint::set_allocated_pointmv(::google::protobuf::PointMV* pointmv) {
  delete pointmv_;
  pointmv_ = pointmv;
  if (pointmv) {
